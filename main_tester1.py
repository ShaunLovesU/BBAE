...
def compute_entropy_and_congruence(bit_data, window_sizes):
    ...
    for window_size in window_sizes:
        ...
        entropy_list = []
        congruence_list = []
        # Cache segment lists for each window
        all_segments = [
        ...
        for i in range(num_windows):
            ...
            entropy_list.append(optimized_calculate_entropy_for_window([''.join(row) for row in win_bits]))
            avg_cong = average_bit_congruence_from_segments(all_segments[i])
            congruence_list.append(avg_cong)
        dict_entropy[window_size] = entropy_list
        dict_congruence[window_size] = congruence_list
